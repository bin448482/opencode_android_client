...
class ModelTests {
    ...
    @Test
    fun `ModelOption reference preserves exact provider and model IDs`() {
        val model = AppState.ModelOption("GPT-5.6 Terra Fast", "openai", "gpt-5.6-terra-fast")

        assertEquals("openai/gpt-5.6-terra-fast", model.reference)
    }
